...
<div className='flex justify-center w-6/12 flex-wrap'>
    <div className='p-8 flex justify-center w-1/2'>
        <Card isBlurred className='w-full p-4 bg-gradient-to-r from-zinc-900 to-zinc-800'>
            ...
            <CardFooter>
                <p>
                    As a Frontend Developer, I specialize in crafting user-friendly interfaces using React. My learnings have honed my problem-solving skills and deepened my understanding of computer science.
